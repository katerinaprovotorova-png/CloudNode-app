...
abstract class $ProfileDetailsStateCopyWith<$Res> {
  factory $ProfileDetailsStateCopyWith(
    ProfileDetailsState value,
    $Res Function(ProfileDetailsState) then,
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.configContent, configContent) ||
                other.configContent == configContent) &&
            (identical(other.isDetailsChanged, isDetailsChanged) ||
                other.isDetailsChanged == isDetailsChanged));
  }
