...
_$FreeProfilesModelImpl _$$FreeProfilesModelImplFromJson(
  Map<String, dynamic> json,
) => _$FreeProfilesModelImpl(
  profiles: (json['profiles'] as List<dynamic>)
      .map((e) => FreeProfile.fromJson(e as Map<String, dynamic>))
      .toList(),
);

Map<String, dynamic> _$$FreeProfilesModelImplToJson(
  _$FreeProfilesModelImpl instance,
) => <String, dynamic>{
  'profiles': instance.profiles.map((e) => e.toJson()).toList(),
};

_$FreeProfileImpl _$$FreeProfileImplFromJson(Map<String, dynamic> json) =>
    _$FreeProfileImpl(
      ...
      neededFeatures: (json['needed_features'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList(),
    );

Map<String, dynamic> _$$FreeProfileImplToJson(_$FreeProfileImpl instance) =>
    <String, dynamic>{
...
Map<String, dynamic> _$$StringByLocaleImplToJson(
  _$StringByLocaleImpl instance,
) => <String, dynamic>{'en': instance.en, 'fa': instance.fa};

_$ListOfStringByLocaleImpl _$$ListOfStringByLocaleImplFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$$ListOfStringByLocaleImplToJson(
  _$ListOfStringByLocaleImpl instance,
) => <String, dynamic>{'en': instance.en, 'fa': instance.fa};
