...
_$PerAppProxyBackupImpl _$$PerAppProxyBackupImplFromJson(
...
Map<String, dynamic> _$$PerAppProxyBackupImplToJson(
  _$PerAppProxyBackupImpl instance,
) => <String, dynamic>{
  'include': instance.include.toJson(),
  'exclude': instance.exclude.toJson(),
};

_$PerAppProxyBackupModeImpl _$$PerAppProxyBackupModeImplFromJson(
  Map<String, dynamic> json,
  ...
  selected:
      ...
      const [],
  deselected:
      (json['deselected'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList() ??
      const [],
);

Map<String, dynamic> _$$PerAppProxyBackupModeImplToJson(
  _$PerAppProxyBackupModeImpl instance,
) => <String, dynamic>{
