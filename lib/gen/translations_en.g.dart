...
class TranslationsIntroEn {
	...
	TextSpan info({required InlineSpanBuilder tap_source, required InlineSpanBuilder tap_license}) => TextSpan(children: [
		const TextSpan(text: 'Made with ❤️ by Hiddify - '),
...
class TranslationsDialogsEn {
	...
	late final TranslationsDialogsPsiphonLicenseEn psiphonLicense = TranslationsDialogsPsiphonLicenseEn.internal(_root);
...
class TranslationsErrorsEn {
	...
	late final TranslationsErrorsPsiphonEn psiphon = TranslationsErrorsPsiphonEn.internal(_root);
}
...
class TranslationsCommonMsgEn {
	...
	late final TranslationsCommonMsgAutoSaveEn autoSave = TranslationsCommonMsgAutoSaveEn.internal(_root);
}
...
class TranslationsPagesHomeEn {
	...
	/// en: 'Quick setting options'
	String get quickSettings => 'Quick setting options';
}
...
class TranslationsPagesSettingsEn {
	...
	late final TranslationsPagesSettingsChainEn chain = TranslationsPagesSettingsChainEn.internal(_root);
}
...
class TranslationsDialogsPsiphonLicenseEn {
	TranslationsDialogsPsiphonLicenseEn.internal(this._root);

	final Translations _root; // ignore: unused_field

	// Translations

	/// en: 'Psiphon License Agreement'
	String get title => 'Psiphon License Agreement';

	/// en: 'By using Psiphon, you agree to the ${tos(Terms of Service)} and acknowledge the ${privacy(Privacy Policy)}. Please read them carefully before proceeding.'
	TextSpan description({required InlineSpanBuilder tos, required InlineSpanBuilder privacy}) => TextSpan(children: [
		const TextSpan(text: 'By using Psiphon, you agree to the '),
		tos('Terms of Service'),
		const TextSpan(text: ' and acknowledge the '),
		privacy('Privacy Policy'),
		const TextSpan(text: '. Please read them carefully before proceeding.'),
	]);
}
...
class TranslationsDialogsConfirmationEn {
	...
	late final TranslationsDialogsConfirmationAddProfileByDeepLinkWarningEn addProfileByDeepLinkWarning = TranslationsDialogsConfirmationAddProfileByDeepLinkWarningEn.internal(_root);
	late final TranslationsDialogsConfirmationImportRouteRuleByDeepLinkWarningEn importRouteRuleByDeepLinkWarning = TranslationsDialogsConfirmationImportRouteRuleByDeepLinkWarningEn.internal(_root);
}
...
class TranslationsErrorsWarpEn {
	...
	/// en: 'Warp license required'
	String get missingLicense => 'Warp license required';
...
// Path: errors.psiphon
class TranslationsErrorsPsiphonEn {
	TranslationsErrorsPsiphonEn.internal(this._root);

	final Translations _root; // ignore: unused_field

	// Translations

	/// en: 'Psiphon license required'
	String get missingLicense => 'Psiphon license required';

	/// en: 'The selected profile uses the Psiphon feature; to use this feature, the Psiphon license must be agreed to'
	String get missingLicenseMsg => 'The selected profile uses the Psiphon feature; to use this feature, the Psiphon license must be agreed to';
}
...
class TranslationsCommonMsgAutoSaveEn {
	TranslationsCommonMsgAutoSaveEn.internal(this._root);

	final Translations _root; // ignore: unused_field

	// Translations

	/// en: 'Changes auto-saved successfully'
	String get success => 'Changes auto-saved successfully';
}
...
class TranslationsPagesSettingsRoutingEn {
	...
	late final TranslationsPagesSettingsRoutingGeneralOptionsEn generalOptions = TranslationsPagesSettingsRoutingGeneralOptionsEn.internal(_root);
	late final TranslationsPagesSettingsRoutingPredefinedRulesEn predefinedRules = TranslationsPagesSettingsRoutingPredefinedRulesEn.internal(_root);
}
...
class TranslationsPagesSettingsInboundEn {
	...
	/// en: 'VPN sharing'
	String get lanSharing => 'VPN sharing';

	/// en: 'Password not set'
	String get lanSharingPasswordNotSet => 'Password not set';

	/// en: 'VPN sharing password'
	String get lanSharingPassword => 'VPN sharing password';
	...
	/// en: 'Failed to get local IP address'
	String get lanIPError => 'Failed to get local IP address';
}
...
class TranslationsPagesSettingsChainEn {
	TranslationsPagesSettingsChainEn.internal(this._root);
	...
	/// en: 'Chain'
	String get title => 'Chain';

	/// en: 'Extra security & Unblocker'
	String get subtitle => 'Extra security & Unblocker';

	/// en: 'Final IP'
	String get finalIp => 'Final IP';

	late final TranslationsPagesSettingsChainLevelsEn levels = TranslationsPagesSettingsChainLevelsEn.internal(_root);
	late final TranslationsPagesSettingsChainWarpEn warp = TranslationsPagesSettingsChainWarpEn.internal(_root);
	late final TranslationsPagesSettingsChainPsiphonEn psiphon = TranslationsPagesSettingsChainPsiphonEn.internal(_root);
	late final TranslationsPagesSettingsChainProfileEn profile = TranslationsPagesSettingsChainProfileEn.internal(_root);
}
...
class TranslationsDialogsConfirmationAddProfileByDeepLinkWarningEn {
	TranslationsDialogsConfirmationAddProfileByDeepLinkWarningEn.internal(this._root);
	...
	/// en: 'Add profile?'
	String get title => 'Add profile?';

	/// en: 'An external link from "${host}" is requesting to add a new profile. Do you want to import it?'
	String message({required Object host}) => 'An external link from "${host}" is requesting to add a new profile. Do you want to import it?';
}

// Path: dialogs.confirmation.importRouteRuleByDeepLinkWarning
class TranslationsDialogsConfirmationImportRouteRuleByDeepLinkWarningEn {
	TranslationsDialogsConfirmationImportRouteRuleByDeepLinkWarningEn.internal(this._root);

	final Translations _root; // ignore: unused_field

	// Translations

	/// en: 'Import route-rule?'
	String get title => 'Import route-rule?';

	/// en: 'Importing route rules from untrusted sources can be a security risk Only proceed if you trust this link'
	String get message => 'Importing route rules from untrusted sources can be a security risk\nOnly proceed if you trust this link';
}
...
class TranslationsPagesSettingsRoutingRouteRuleEn {
	...
	/// en: 'No rules added yet Tap the + button to create a new rule or choose from predefined rules'
	String get empty => 'No rules added yet\n\nTap the + button to create a new rule or choose from predefined rules';

	/// en: 'Delete rule'
	String get delete => 'Delete rule';

	/// en: 'Create new rule'
	String get create => 'Create new rule';
...
class TranslationsPagesSettingsRoutingGeneralOptionsEn {
	TranslationsPagesSettingsRoutingGeneralOptionsEn.internal(this._root);

	final Translations _root; // ignore: unused_field

	// Translations

	/// en: 'Route general options'
	String get title => 'Route general options';

	/// en: 'Region'
	String get region => 'Region';

	late final TranslationsPagesSettingsRoutingGeneralOptionsRegionsEn regions = TranslationsPagesSettingsRoutingGeneralOptionsRegionsEn.internal(_root);
	late final TranslationsPagesSettingsRoutingGeneralOptionsBalancerStrategyEn balancerStrategy = TranslationsPagesSettingsRoutingGeneralOptionsBalancerStrategyEn.internal(_root);
	...
	late final TranslationsPagesSettingsRoutingGeneralOptionsIpv6ModesEn ipv6Modes = TranslationsPagesSettingsRoutingGeneralOptionsIpv6ModesEn.internal(_root);
	late final TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyEn perAppProxy = TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyEn.internal(_root);
}

// Path: pages.settings.routing.predefinedRules
class TranslationsPagesSettingsRoutingPredefinedRulesEn {
	TranslationsPagesSettingsRoutingPredefinedRulesEn.internal(this._root);
	...
	/// en: 'Predefined rules'
	String get title => 'Predefined rules';

	late final TranslationsPagesSettingsRoutingPredefinedRulesAdsEn ads = TranslationsPagesSettingsRoutingPredefinedRulesAdsEn.internal(_root);
	late final TranslationsPagesSettingsRoutingPredefinedRulesBypassLanEn bypassLan = TranslationsPagesSettingsRoutingPredefinedRulesBypassLanEn.internal(_root);
}
...
class TranslationsPagesSettingsChainLevelsEn {
	TranslationsPagesSettingsChainLevelsEn.internal(this._root);

	final Translations _root; // ignore: unused_field

	// Translations
	late final TranslationsPagesSettingsChainLevelsAppEn app = TranslationsPagesSettingsChainLevelsAppEn.internal(_root);
	late final TranslationsPagesSettingsChainLevelsExtraSecurityEn extraSecurity = TranslationsPagesSettingsChainLevelsExtraSecurityEn.internal(_root);
	late final TranslationsPagesSettingsChainLevelsMainProfileEn mainProfile = TranslationsPagesSettingsChainLevelsMainProfileEn.internal(_root);
	late final TranslationsPagesSettingsChainLevelsUnblockerEn unblocker = TranslationsPagesSettingsChainLevelsUnblockerEn.internal(_root);
	late final TranslationsPagesSettingsChainLevelsFilteringEn filtering = TranslationsPagesSettingsChainLevelsFilteringEn.internal(_root);
}

// Path: pages.settings.chain.warp
class TranslationsPagesSettingsChainWarpEn {
	TranslationsPagesSettingsChainWarpEn.internal(this._root);
	...
	late final TranslationsPagesSettingsChainWarpNoiseEn noise = TranslationsPagesSettingsChainWarpNoiseEn.internal(_root);
}

// Path: pages.settings.chain.psiphon
class TranslationsPagesSettingsChainPsiphonEn {
	TranslationsPagesSettingsChainPsiphonEn.internal(this._root);

	final Translations _root; // ignore: unused_field

	// Translations

	/// en: 'Select server region'
	String get selectServerRegion => 'Select server region';

	late final TranslationsPagesSettingsChainPsiphonRegionsEn regions = TranslationsPagesSettingsChainPsiphonRegionsEn.internal(_root);
}

// Path: pages.settings.chain.profile
class TranslationsPagesSettingsChainProfileEn {
	TranslationsPagesSettingsChainProfileEn.internal(this._root);
	...
	/// en: 'Conduit pairing ID'
	String get conduitPairingId => 'Conduit pairing ID';
}
...
class TranslationsPagesSettingsRoutingGeneralOptionsRegionsEn {
	TranslationsPagesSettingsRoutingGeneralOptionsRegionsEn.internal(this._root);
...
class TranslationsPagesSettingsRoutingGeneralOptionsBalancerStrategyEn {
	TranslationsPagesSettingsRoutingGeneralOptionsBalancerStrategyEn.internal(this._root);
...
class TranslationsPagesSettingsRoutingGeneralOptionsIpv6ModesEn {
	TranslationsPagesSettingsRoutingGeneralOptionsIpv6ModesEn.internal(this._root);
...
class TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyEn {
	TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyEn.internal(this._root);
	...
	late final TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyOptionsEn options = TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyOptionsEn.internal(_root);
	late final TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyModesEn modes = TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyModesEn.internal(_root);
	late final TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyAutoSelectionEn autoSelection = TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyAutoSelectionEn.internal(_root);
}

// Path: pages.settings.routing.predefinedRules.ads
class TranslationsPagesSettingsRoutingPredefinedRulesAdsEn {
	TranslationsPagesSettingsRoutingPredefinedRulesAdsEn.internal(this._root);
...
class TranslationsPagesSettingsRoutingPredefinedRulesBypassLanEn {
	TranslationsPagesSettingsRoutingPredefinedRulesBypassLanEn.internal(this._root);
...
class TranslationsPagesSettingsChainLevelsAppEn {
	TranslationsPagesSettingsChainLevelsAppEn.internal(this._root);
	...
	/// en: 'Start point: Your app traffic enters the chain here and passes through the next layers to prepare for the final bypass'
	String get msg => 'Start point: Your app traffic enters the chain here and passes through the next layers to prepare for the final bypass';
}

// Path: pages.settings.chain.levels.extraSecurity
class TranslationsPagesSettingsChainLevelsExtraSecurityEn {
	TranslationsPagesSettingsChainLevelsExtraSecurityEn.internal(this._root);
	...
	/// en: 'Extra security'
	String get title => 'Extra security';

	/// en: 'Adds an extra shield to keep your data private, even if your main profile is untrusted'
	String get msg => 'Adds an extra shield to keep your data private, even if your main profile is untrusted';
}

// Path: pages.settings.chain.levels.mainProfile
class TranslationsPagesSettingsChainLevelsMainProfileEn {
	TranslationsPagesSettingsChainLevelsMainProfileEn.internal(this._root);
	...
	/// en: 'Main profile'
	String get title => 'Main profile';
}

// Path: pages.settings.chain.levels.unblocker
class TranslationsPagesSettingsChainLevelsUnblockerEn {
	TranslationsPagesSettingsChainLevelsUnblockerEn.internal(this._root);
	...
	/// en: 'Unblocker'
	String get title => 'Unblocker';

	/// en: 'Helps bypass network restrictions. If the helper connects, your main profile can still work even if it's currently blocked'
	String get msg => 'Helps bypass network restrictions. If the helper connects, your main profile can still work even if it\'s currently blocked';
}

// Path: pages.settings.chain.levels.filtering
class TranslationsPagesSettingsChainLevelsFilteringEn {
	TranslationsPagesSettingsChainLevelsFilteringEn.internal(this._root);
	...
	/// en: 'Filtering'
	String get title => 'Filtering';

	/// en: 'Final exit: After passing through the active layers (Extra Security, Main Profile, or Unblocker) and applying their effects, your traffic is finally routed to bypass local network filtering'
	String get msg => 'Final exit: After passing through the active layers (Extra Security, Main Profile, or Unblocker) and applying their effects, your traffic is finally routed to bypass local network filtering';
}

// Path: pages.settings.chain.warp.noise
class TranslationsPagesSettingsChainWarpNoiseEn {
	TranslationsPagesSettingsChainWarpNoiseEn.internal(this._root);
...
class TranslationsPagesSettingsChainPsiphonRegionsEn {
	TranslationsPagesSettingsChainPsiphonRegionsEn.internal(this._root);
	...
	/// en: 'Auto'
	String get auto => _root.common.auto;

	/// en: 'Austria (at)'
	String get at => 'Austria (at)';

	/// en: 'Australia (au)'
	String get au => 'Australia (au)';

	/// en: 'Belgium (be)'
	String get be => 'Belgium (be)';

	/// en: 'Bulgaria (bg)'
	String get bg => 'Bulgaria (bg)';

	/// en: 'Canada (ca)'
	String get ca => 'Canada (ca)';

	/// en: 'Switzerland (ch)'
	String get ch => 'Switzerland (ch)';

	/// en: 'Czech Republic (cz)'
	String get cz => 'Czech Republic (cz)';

	/// en: 'Germany (de)'
	String get de => 'Germany (de)';

	/// en: 'Denmark (dk)'
	String get dk => 'Denmark (dk)';

	/// en: 'Estonia (ee)'
	String get ee => 'Estonia (ee)';

	/// en: 'Spain (es)'
	String get es => 'Spain (es)';

	/// en: 'Finland (fi)'
	String get fi => 'Finland (fi)';

	/// en: 'France (fr)'
	String get fr => 'France (fr)';

	/// en: 'United Kingdom (gb)'
	String get gb => 'United Kingdom (gb)';

	/// en: 'Croatia (hr)'
	String get hr => 'Croatia (hr)';

	/// en: 'Hungary (hu)'
	String get hu => 'Hungary (hu)';

	/// en: 'Ireland (ie)'
	String get ie => 'Ireland (ie)';

	/// en: 'India (in)'
	String get kIn => 'India (in)';

	/// en: 'Italy (it)'
	String get it => 'Italy (it)';

	/// en: 'Japan (jp)'
	String get jp => 'Japan (jp)';

	/// en: 'Latvia (lv)'
	String get lv => 'Latvia (lv)';

	/// en: 'Netherlands (nl)'
	String get nl => 'Netherlands (nl)';

	/// en: 'Norway (no)'
	String get no => 'Norway (no)';

	/// en: 'Poland (pl)'
	String get pl => 'Poland (pl)';

	/// en: 'Portugal (pt)'
	String get pt => 'Portugal (pt)';

	/// en: 'Romania (ro)'
	String get ro => 'Romania (ro)';

	/// en: 'Serbia (rs)'
	String get rs => 'Serbia (rs)';

	/// en: 'Sweden (se)'
	String get se => 'Sweden (se)';

	/// en: 'Singapore (sg)'
	String get sg => 'Singapore (sg)';

	/// en: 'Slovakia (sk)'
	String get sk => 'Slovakia (sk)';

	/// en: 'United States (us)'
	String get us => 'United States (us)';
}
...
class TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyOptionsEn {
	TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyOptionsEn.internal(this._root);

	final Translations _root; // ignore: unused_field

	// Translations
	late final TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyOptionsImportEn import = TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyOptionsImportEn.internal(_root);
	late final TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyOptionsExportEn export = TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyOptionsExportEn.internal(_root);
...
class TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyModesEn {
	TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyModesEn.internal(this._root);
...
class TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyAutoSelectionEn {
	TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyAutoSelectionEn.internal(this._root);
	...
	late final TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyAutoSelectionToastEn toast = TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyAutoSelectionToastEn.internal(_root);
	late final TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyAutoSelectionDialogEn dialog = TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyAutoSelectionDialogEn.internal(_root);
}

// Path: pages.settings.routing.generalOptions.perAppProxy.options.import
class TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyOptionsImportEn {
	TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyOptionsImportEn.internal(this._root);
...
class TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyOptionsExportEn {
	TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyOptionsExportEn.internal(this._root);
...
class TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyAutoSelectionToastEn {
	TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyAutoSelectionToastEn.internal(this._root);
...
class TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyAutoSelectionDialogEn {
	TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyAutoSelectionDialogEn.internal(this._root);
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'common.msg.autoSave.success': return 'Changes auto-saved successfully';
			...
			case 'pages.home.quickSettings': return 'Quick setting options';
			...
			case 'pages.settings.routing.routeRule.empty': return 'No rules added yet\n\nTap the + button to create a new rule or choose from predefined rules';
			case 'pages.settings.routing.routeRule.delete': return 'Delete rule';
			case 'pages.settings.routing.routeRule.create': return 'Create new rule';
			...
			case 'pages.settings.routing.generalOptions.title': return 'Route general options';
			case 'pages.settings.routing.generalOptions.region': return 'Region';
			...
			case 'pages.settings.routing.generalOptions.regions.ru': return 'Russia (ru)';
			...
			case 'pages.settings.routing.generalOptions.regions.br': return 'Brazil (br)';
			case 'pages.settings.routing.generalOptions.regions.other': return 'Other';
			case 'pages.settings.routing.generalOptions.balancerStrategy.title': return 'Balancer strategy';
			...
			case 'pages.settings.routing.generalOptions.resolveDestination': return 'Resolve destination';
			case 'pages.settings.routing.generalOptions.ipv6Route': return 'IPv6 route';
			case 'pages.settings.routing.generalOptions.ipv6Modes.disable': return 'Disable';
			case 'pages.settings.routing.generalOptions.ipv6Modes.enable': return 'Enable';
			case 'pages.settings.routing.generalOptions.ipv6Modes.prefer': return 'Preferred';
			case 'pages.settings.routing.generalOptions.ipv6Modes.only': return 'Exclusive';
			case 'pages.settings.routing.generalOptions.perAppProxy.title': return 'Per-app proxy';
			case 'pages.settings.routing.generalOptions.perAppProxy.hideSysApps': return 'Hide system apps';
			case 'pages.settings.routing.generalOptions.perAppProxy.options.import.clipboard': return 'Import selection from clipboard';
			case 'pages.settings.routing.generalOptions.perAppProxy.options.import.file': return 'Import selection from file';
			case 'pages.settings.routing.generalOptions.perAppProxy.options.import.msg': return 'Importing will replace your current selections. Are you sure you want to continue?';
			case 'pages.settings.routing.generalOptions.perAppProxy.options.export.clipboard': return 'Copy selection to clipboard';
			case 'pages.settings.routing.generalOptions.perAppProxy.options.export.file': return 'Export selection to file';
			case 'pages.settings.routing.generalOptions.perAppProxy.options.shareToAll': return 'Share to all';
			case 'pages.settings.routing.generalOptions.perAppProxy.options.clearAllSelections': return 'Clear all selections';
			case 'pages.settings.routing.generalOptions.perAppProxy.modes.all': return 'All';
			...
			case 'pages.settings.routing.generalOptions.perAppProxy.modes.allMsg': return 'Proxy all apps';
			case 'pages.settings.routing.generalOptions.perAppProxy.modes.proxyMsg': return 'Proxy only selected apps';
			case 'pages.settings.routing.generalOptions.perAppProxy.modes.bypassMsg': return 'Do not proxy selected apps';
			case 'pages.settings.routing.generalOptions.perAppProxy.autoSelection.title': return 'Auto selection';
			case 'pages.settings.routing.generalOptions.perAppProxy.autoSelection.performNow': return 'Perform now';
			case 'pages.settings.routing.generalOptions.perAppProxy.autoSelection.resetToDefault': return 'Reset to default';
			case 'pages.settings.routing.generalOptions.perAppProxy.autoSelection.autoUpdateInterval': return 'Auto update interval';
			case 'pages.settings.routing.generalOptions.perAppProxy.autoSelection.toast.success': return 'Auto apps selection completed successfully';
			case 'pages.settings.routing.generalOptions.perAppProxy.autoSelection.toast.failure': return 'Auto selection failed';
			case 'pages.settings.routing.generalOptions.perAppProxy.autoSelection.toast.regionNotFound': return ({required Object region}) => 'Auto selection not found, region "${region}"';
			case 'pages.settings.routing.generalOptions.perAppProxy.autoSelection.toast.alreadyInAuto': return 'Your selections are already in the auto-list';
			case 'pages.settings.routing.generalOptions.perAppProxy.autoSelection.dialog.title': return 'Auto apps selection';
			case 'pages.settings.routing.generalOptions.perAppProxy.autoSelection.dialog.msg': return ({required Object region}) => 'The auto selection feature for per-app proxy was disabled due to the region change to "${region}"';
			case 'pages.settings.routing.predefinedRules.title': return 'Predefined rules';
			case 'pages.settings.routing.predefinedRules.ads.name': return 'Block ads';
			case 'pages.settings.routing.predefinedRules.ads.description': return '';
			case 'pages.settings.routing.predefinedRules.bypassLan.name': return 'Bypass LAN';
			...
			case 'pages.settings.inbound.lanSharing': return 'VPN sharing';
			case 'pages.settings.inbound.lanSharingPasswordNotSet': return 'Password not set';
			case 'pages.settings.inbound.lanSharingPassword': return 'VPN sharing password';
			case 'pages.settings.inbound.copyLink': return 'Copy link';
			case 'pages.settings.inbound.qrCode': return 'QR Code';
			case 'pages.settings.inbound.lanIPError': return 'Failed to get local IP address';
			...
			case 'pages.settings.chain.title': return 'Chain';
			case 'pages.settings.chain.subtitle': return 'Extra security & Unblocker';
			case 'pages.settings.chain.finalIp': return 'Final IP';
			case 'pages.settings.chain.levels.app.title': return 'App';
			case 'pages.settings.chain.levels.app.msg': return 'Start point: Your app traffic enters the chain here and passes through the next layers to prepare for the final bypass';
			case 'pages.settings.chain.levels.extraSecurity.title': return 'Extra security';
			case 'pages.settings.chain.levels.extraSecurity.msg': return 'Adds an extra shield to keep your data private, even if your main profile is untrusted';
			case 'pages.settings.chain.levels.mainProfile.title': return 'Main profile';
			case 'pages.settings.chain.levels.unblocker.title': return 'Unblocker';
			case 'pages.settings.chain.levels.unblocker.msg': return 'Helps bypass network restrictions. If the helper connects, your main profile can still work even if it\'s currently blocked';
			case 'pages.settings.chain.levels.filtering.title': return 'Filtering';
			case 'pages.settings.chain.levels.filtering.msg': return 'Final exit: After passing through the active layers (Extra Security, Main Profile, or Unblocker) and applying their effects, your traffic is finally routed to bypass local network filtering';
			case 'pages.settings.chain.warp.missingConfig': return 'Missing WARP config';
			case 'pages.settings.chain.warp.licenseKey': return 'License key';
			case 'pages.settings.chain.warp.cleanIp': return 'Clean IP';
			case 'pages.settings.chain.warp.port': return 'Port';
			case 'pages.settings.chain.warp.noise.count': return 'Noise count';
			case 'pages.settings.chain.warp.noise.mode': return 'Noise mode';
			case 'pages.settings.chain.warp.noise.size': return 'Noise size';
			case 'pages.settings.chain.warp.noise.delay': return 'Noise delay';
			case 'pages.settings.chain.psiphon.selectServerRegion': return 'Select server region';
			...
			case 'pages.settings.chain.psiphon.regions.be': return 'Belgium (be)';
			...
			case 'pages.settings.chain.psiphon.regions.ch': return 'Switzerland (ch)';
			case 'pages.settings.chain.psiphon.regions.cz': return 'Czech Republic (cz)';
			case 'pages.settings.chain.psiphon.regions.de': return 'Germany (de)';
			...
			case 'pages.settings.chain.psiphon.regions.es': return 'Spain (es)';
			case 'pages.settings.chain.psiphon.regions.fi': return 'Finland (fi)';
			case 'pages.settings.chain.psiphon.regions.fr': return 'France (fr)';
			case 'pages.settings.chain.psiphon.regions.gb': return 'United Kingdom (gb)';
			case 'pages.settings.chain.psiphon.regions.hr': return 'Croatia (hr)';
			case 'pages.settings.chain.psiphon.regions.hu': return 'Hungary (hu)';
			case 'pages.settings.chain.psiphon.regions.ie': return 'Ireland (ie)';
			case 'pages.settings.chain.psiphon.regions.kIn': return 'India (in)';
			case 'pages.settings.chain.psiphon.regions.it': return 'Italy (it)';
			case 'pages.settings.chain.psiphon.regions.jp': return 'Japan (jp)';
			case 'pages.settings.chain.psiphon.regions.lv': return 'Latvia (lv)';
			case 'pages.settings.chain.psiphon.regions.nl': return 'Netherlands (nl)';
			case 'pages.settings.chain.psiphon.regions.no': return 'Norway (no)';
			case 'pages.settings.chain.psiphon.regions.pl': return 'Poland (pl)';
			case 'pages.settings.chain.psiphon.regions.pt': return 'Portugal (pt)';
			case 'pages.settings.chain.psiphon.regions.ro': return 'Romania (ro)';
			case 'pages.settings.chain.psiphon.regions.rs': return 'Serbia (rs)';
			case 'pages.settings.chain.psiphon.regions.se': return 'Sweden (se)';
			case 'pages.settings.chain.psiphon.regions.sg': return 'Singapore (sg)';
			case 'pages.settings.chain.psiphon.regions.sk': return 'Slovakia (sk)';
			case 'pages.settings.chain.psiphon.regions.us': return 'United States (us)';
			case 'pages.settings.chain.profile.selectProfile': return 'Select profile';
			case 'pages.settings.chain.profile.conduitPairingId': return 'Conduit pairing ID';
			...
			case 'dialogs.psiphonLicense.title': return 'Psiphon License Agreement';
			...
			case 'dialogs.confirmation.addProfileByDeepLinkWarning.title': return 'Add profile?';
			case 'dialogs.confirmation.addProfileByDeepLinkWarning.message': return ({required Object host}) => 'An external link from "${host}" is requesting to add a new profile. Do you want to import it?';
			case 'dialogs.confirmation.importRouteRuleByDeepLinkWarning.title': return 'Import route-rule?';
			case 'dialogs.confirmation.importRouteRuleByDeepLinkWarning.message': return 'Importing route rules from untrusted sources can be a security risk\nOnly proceed if you trust this link';
			...
			case 'errors.warp.missingLicense': return 'Warp license required';
			...
			case 'errors.psiphon.missingLicense': return 'Psiphon license required';
			case 'errors.psiphon.missingLicenseMsg': return 'The selected profile uses the Psiphon feature; to use this feature, the Psiphon license must be agreed to';
			default: return null;
		}
	}
}
