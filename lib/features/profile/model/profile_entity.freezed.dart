...
class _$RemoteProfileEntityImpl extends RemoteProfileEntity {
  ...
  @override
  String toString() {
    return 'ProfileEntity.remote(id: $id, active: $active, name: $name, url: $url, lastUpdate: $lastUpdate, options: $options, subInfo: $subInfo, populatedHeaders: $populatedHeaders, userOverride: $userOverride)';
  }
...
class _$LocalProfileEntityImpl extends LocalProfileEntity {
  ...
  @override
  String toString() {
    return 'ProfileEntity.local(id: $id, active: $active, name: $name, lastUpdate: $lastUpdate, populatedHeaders: $populatedHeaders, userOverride: $userOverride)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return local(id, active, name, lastUpdate, populatedHeaders, userOverride);
  }
...
mixin _$UserOverride {
  ...
  bool? get enablePsiphon => throw _privateConstructorUsedError;
      ...
      _value.copyWith(
            ...
            enableWarp: freezed == enableWarp
                ...
                : enableWarp // ignore: cast_nullable_to_non_nullable
                      as bool?,
            enablePsiphon: freezed == enablePsiphon
                ? _value.enablePsiphon
                : enablePsiphon // ignore: cast_nullable_to_non_nullable
                      as bool?,
...
class _$UserOverrideImpl extends _UserOverride {
  ...
  @override
  final bool? enablePsiphon;
  @override
  final bool? enableFragment;

  @override
  String toString() {
    return 'UserOverride(version: $version, name: $name, isAutoUpdateDisable: $isAutoUpdateDisable, updateInterval: $updateInterval, enableWarp: $enableWarp, enablePsiphon: $enablePsiphon, enableFragment: $enableFragment)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.enablePsiphon, enablePsiphon) ||
                other.enablePsiphon == enablePsiphon) &&
