...
class TranslationsCommonFa extends TranslationsCommonEn {
	...
	@override String get psiphon => 'سایفون';
	@override String get profile => 'پروفایل';
	@override String get configuration => 'پیکربندی';
...
class TranslationsDialogsFa extends TranslationsDialogsEn {
	...
	@override late final TranslationsDialogsPsiphonLicenseFa psiphonLicense = TranslationsDialogsPsiphonLicenseFa._(_root);
...
class TranslationsErrorsFa extends TranslationsErrorsEn {
	...
	@override late final TranslationsErrorsPsiphonFa psiphon = TranslationsErrorsPsiphonFa._(_root);
}
...
class TranslationsCommonMsgFa extends TranslationsCommonMsgEn {
	...
	@override late final TranslationsCommonMsgAutoSaveFa autoSave = TranslationsCommonMsgAutoSaveFa._(_root);
}
...
class TranslationsPagesHomeFa extends TranslationsPagesHomeEn {
	...
	@override String get quickSettings => 'گزینه‌های تنظیمات سریع';
}
...
class TranslationsPagesSettingsFa extends TranslationsPagesSettingsEn {
	...
	@override late final TranslationsPagesSettingsChainFa chain = TranslationsPagesSettingsChainFa._(_root);
}
...
class TranslationsDialogsPsiphonLicenseFa extends TranslationsDialogsPsiphonLicenseEn {
	TranslationsDialogsPsiphonLicenseFa._(TranslationsFa root) : this._root = root, super.internal(root);

	final TranslationsFa _root; // ignore: unused_field

	// Translations
	@override String get title => 'قرارداد لایسنس Psiphon';
	@override TextSpan description({required InlineSpanBuilder tos, required InlineSpanBuilder privacy}) => TextSpan(children: [
		const TextSpan(text: 'با استفاده از Psiphon، شما با '),
		tos('شرایط خدمات'),
		const TextSpan(text: ' موافقت کرده و '),
		privacy('سیاست حفظ حریم خصوصی'),
		const TextSpan(text: ' را تایید می‌کنید. لطفاً پیش از ادامه، آن‌ها را با دقت بخوانید.'),
	]);
}
...
class TranslationsDialogsConfirmationFa extends TranslationsDialogsConfirmationEn {
	...
	@override late final TranslationsDialogsConfirmationAddProfileByDeepLinkWarningFa addProfileByDeepLinkWarning = TranslationsDialogsConfirmationAddProfileByDeepLinkWarningFa._(_root);
	@override late final TranslationsDialogsConfirmationImportRouteRuleByDeepLinkWarningFa importRouteRuleByDeepLinkWarning = TranslationsDialogsConfirmationImportRouteRuleByDeepLinkWarningFa._(_root);
}
...
class TranslationsErrorsWarpFa extends TranslationsErrorsWarpEn {
	...
	// Translations
	@override String get missingLicense => 'لایسنس WARP لازم است';
...
// Path: errors.psiphon
class TranslationsErrorsPsiphonFa extends TranslationsErrorsPsiphonEn {
	TranslationsErrorsPsiphonFa._(TranslationsFa root) : this._root = root, super.internal(root);

	final TranslationsFa _root; // ignore: unused_field

	// Translations
	@override String get missingLicense => 'لایسنس Psiphon لازم است';
	@override String get missingLicenseMsg => 'پروفایل انتخاب‌شده از ویژگی Psiphon استفاده می‌کند؛ برای استفاده از این قابلیت، باید با لایسنس Psiphon موافقت شود';
}
...
class TranslationsCommonMsgAutoSaveFa extends TranslationsCommonMsgAutoSaveEn {
	TranslationsCommonMsgAutoSaveFa._(TranslationsFa root) : this._root = root, super.internal(root);

	final TranslationsFa _root; // ignore: unused_field

	// Translations
	@override String get success => 'تغییرات با موفقیت به‌طور خودکار ذخیره شد';
}
...
class TranslationsPagesProxiesSortOptionsFa extends TranslationsPagesProxiesSortOptionsEn {
	...
	@override String get usage => 'بر اساس استفاده';
}
...
class TranslationsPagesSettingsRoutingFa extends TranslationsPagesSettingsRoutingEn {
	...
	@override late final TranslationsPagesSettingsRoutingGeneralOptionsFa generalOptions = TranslationsPagesSettingsRoutingGeneralOptionsFa._(_root);
	@override late final TranslationsPagesSettingsRoutingPredefinedRulesFa predefinedRules = TranslationsPagesSettingsRoutingPredefinedRulesFa._(_root);
}
...
class TranslationsPagesSettingsInboundFa extends TranslationsPagesSettingsInboundEn {
	...
	@override String get lanSharing => 'اشتراک VPN';
	@override String get lanSharingPasswordNotSet => 'رمز عبور تنظیم نشده';
	@override String get lanSharingPassword => 'رمز عبور اشتراک VPN';
	@override String get copyLink => 'کپی لینک';
	@override String get qrCode => 'کد QR';
	@override String get lanIPError => 'خطا در دریافت آدرس IP محلی';
}
...
class TranslationsPagesSettingsChainFa extends TranslationsPagesSettingsChainEn {
	TranslationsPagesSettingsChainFa._(TranslationsFa root) : this._root = root, super.internal(root);

	final TranslationsFa _root; // ignore: unused_field

	// Translations
	@override String get title => 'زنجیره';
	@override String get subtitle => 'امنیت بیشتر و رفع مسدودیت';
	@override String get finalIp => 'آی‌پی نهایی';
	@override late final TranslationsPagesSettingsChainLevelsFa levels = TranslationsPagesSettingsChainLevelsFa._(_root);
	@override late final TranslationsPagesSettingsChainWarpFa warp = TranslationsPagesSettingsChainWarpFa._(_root);
	@override late final TranslationsPagesSettingsChainPsiphonFa psiphon = TranslationsPagesSettingsChainPsiphonFa._(_root);
	@override late final TranslationsPagesSettingsChainProfileFa profile = TranslationsPagesSettingsChainProfileFa._(_root);
}
...
class TranslationsDialogsConfirmationAddProfileByDeepLinkWarningFa extends TranslationsDialogsConfirmationAddProfileByDeepLinkWarningEn {
	TranslationsDialogsConfirmationAddProfileByDeepLinkWarningFa._(TranslationsFa root) : this._root = root, super.internal(root);

	final TranslationsFa _root; // ignore: unused_field

	// Translations
	@override String get title => 'افزودن پروفایل؟';
	@override String message({required Object host}) => 'یک لینک خارجی از «${host}» درخواست افزودن پروفایل جدید دارد. آیا می‌خواهید آن را وارد کنید؟';
}

// Path: dialogs.confirmation.importRouteRuleByDeepLinkWarning
class TranslationsDialogsConfirmationImportRouteRuleByDeepLinkWarningFa extends TranslationsDialogsConfirmationImportRouteRuleByDeepLinkWarningEn {
	TranslationsDialogsConfirmationImportRouteRuleByDeepLinkWarningFa._(TranslationsFa root) : this._root = root, super.internal(root);

	final TranslationsFa _root; // ignore: unused_field

	// Translations
	@override String get title => 'وارد کردن قانون مسیریابی؟';
	@override String get message => 'وارد کردن قوانین مسیریابی از منابع غیرقابل اعتماد می‌تواند ریسک امنیتی باشد\nفقط در صورتی که به این لینک اعتماد دارید ادامه دهید';
}
...
class TranslationsPagesSettingsRoutingRouteRuleFa extends TranslationsPagesSettingsRoutingRouteRuleEn {
	...
	// Translations
	@override String get empty => 'هنوز هیچ قانونی اضافه نشده است\n\nبرای ایجاد قانون جدید یا انتخاب از قوانین پیش‌فرض، روی دکمه + ضربه بزنید';
	@override String get delete => 'حذف قانون';
	@override String get create => 'ایجاد قانون جدید';
...
class TranslationsPagesSettingsRoutingGeneralOptionsFa extends TranslationsPagesSettingsRoutingGeneralOptionsEn {
	TranslationsPagesSettingsRoutingGeneralOptionsFa._(TranslationsFa root) : this._root = root, super.internal(root);

	final TranslationsFa _root; // ignore: unused_field

	// Translations
	@override String get title => 'تنظیمات عمومی مسیریابی';
	@override String get region => 'منطقه';
	@override late final TranslationsPagesSettingsRoutingGeneralOptionsRegionsFa regions = TranslationsPagesSettingsRoutingGeneralOptionsRegionsFa._(_root);
	@override late final TranslationsPagesSettingsRoutingGeneralOptionsBalancerStrategyFa balancerStrategy = TranslationsPagesSettingsRoutingGeneralOptionsBalancerStrategyFa._(_root);
	@override String get resolveDestination => 'تحلیل آدرس مقصد';
	@override String get ipv6Route => 'مسیریابی IPv6';
	@override late final TranslationsPagesSettingsRoutingGeneralOptionsIpv6ModesFa ipv6Modes = TranslationsPagesSettingsRoutingGeneralOptionsIpv6ModesFa._(_root);
	@override late final TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyFa perAppProxy = TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyFa._(_root);
}

// Path: pages.settings.routing.predefinedRules
class TranslationsPagesSettingsRoutingPredefinedRulesFa extends TranslationsPagesSettingsRoutingPredefinedRulesEn {
	TranslationsPagesSettingsRoutingPredefinedRulesFa._(TranslationsFa root) : this._root = root, super.internal(root);

	final TranslationsFa _root; // ignore: unused_field

	// Translations
	@override String get title => 'قوانین پیش‌فرض';
	@override late final TranslationsPagesSettingsRoutingPredefinedRulesAdsFa ads = TranslationsPagesSettingsRoutingPredefinedRulesAdsFa._(_root);
	@override late final TranslationsPagesSettingsRoutingPredefinedRulesBypassLanFa bypassLan = TranslationsPagesSettingsRoutingPredefinedRulesBypassLanFa._(_root);
}
...
class TranslationsPagesSettingsChainLevelsFa extends TranslationsPagesSettingsChainLevelsEn {
	TranslationsPagesSettingsChainLevelsFa._(TranslationsFa root) : this._root = root, super.internal(root);

	final TranslationsFa _root; // ignore: unused_field

	// Translations
	@override late final TranslationsPagesSettingsChainLevelsAppFa app = TranslationsPagesSettingsChainLevelsAppFa._(_root);
	@override late final TranslationsPagesSettingsChainLevelsExtraSecurityFa extraSecurity = TranslationsPagesSettingsChainLevelsExtraSecurityFa._(_root);
	@override late final TranslationsPagesSettingsChainLevelsMainProfileFa mainProfile = TranslationsPagesSettingsChainLevelsMainProfileFa._(_root);
	@override late final TranslationsPagesSettingsChainLevelsUnblockerFa unblocker = TranslationsPagesSettingsChainLevelsUnblockerFa._(_root);
	@override late final TranslationsPagesSettingsChainLevelsFilteringFa filtering = TranslationsPagesSettingsChainLevelsFilteringFa._(_root);
}

// Path: pages.settings.chain.warp
class TranslationsPagesSettingsChainWarpFa extends TranslationsPagesSettingsChainWarpEn {
	TranslationsPagesSettingsChainWarpFa._(TranslationsFa root) : this._root = root, super.internal(root);
	...
	@override String get cleanIp => 'آی‌پی تمیز';
	@override String get port => 'پورت';
	@override late final TranslationsPagesSettingsChainWarpNoiseFa noise = TranslationsPagesSettingsChainWarpNoiseFa._(_root);
}

// Path: pages.settings.chain.psiphon
class TranslationsPagesSettingsChainPsiphonFa extends TranslationsPagesSettingsChainPsiphonEn {
	TranslationsPagesSettingsChainPsiphonFa._(TranslationsFa root) : this._root = root, super.internal(root);

	final TranslationsFa _root; // ignore: unused_field

	// Translations
	@override String get selectServerRegion => 'انتخاب منطقه سرور';
	@override late final TranslationsPagesSettingsChainPsiphonRegionsFa regions = TranslationsPagesSettingsChainPsiphonRegionsFa._(_root);
}

// Path: pages.settings.chain.profile
class TranslationsPagesSettingsChainProfileFa extends TranslationsPagesSettingsChainProfileEn {
	TranslationsPagesSettingsChainProfileFa._(TranslationsFa root) : this._root = root, super.internal(root);

	final TranslationsFa _root; // ignore: unused_field

	// Translations
	@override String get selectProfile => 'انتخاب پروفایل';
	@override String get conduitPairingId => 'شناسه جفت‌سازی Conduit';
}
...
class TranslationsPagesSettingsRoutingGeneralOptionsRegionsFa extends TranslationsPagesSettingsRoutingGeneralOptionsRegionsEn {
	TranslationsPagesSettingsRoutingGeneralOptionsRegionsFa._(TranslationsFa root) : this._root = root, super.internal(root);
...
class TranslationsPagesSettingsRoutingGeneralOptionsBalancerStrategyFa extends TranslationsPagesSettingsRoutingGeneralOptionsBalancerStrategyEn {
	TranslationsPagesSettingsRoutingGeneralOptionsBalancerStrategyFa._(TranslationsFa root) : this._root = root, super.internal(root);
...
class TranslationsPagesSettingsRoutingGeneralOptionsIpv6ModesFa extends TranslationsPagesSettingsRoutingGeneralOptionsIpv6ModesEn {
	TranslationsPagesSettingsRoutingGeneralOptionsIpv6ModesFa._(TranslationsFa root) : this._root = root, super.internal(root);
...
class TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyFa extends TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyEn {
	TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyFa._(TranslationsFa root) : this._root = root, super.internal(root);
	...
	@override late final TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyOptionsFa options = TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyOptionsFa._(_root);
	@override late final TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyModesFa modes = TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyModesFa._(_root);
	@override late final TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyAutoSelectionFa autoSelection = TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyAutoSelectionFa._(_root);
}

// Path: pages.settings.routing.predefinedRules.ads
class TranslationsPagesSettingsRoutingPredefinedRulesAdsFa extends TranslationsPagesSettingsRoutingPredefinedRulesAdsEn {
	TranslationsPagesSettingsRoutingPredefinedRulesAdsFa._(TranslationsFa root) : this._root = root, super.internal(root);

	final TranslationsFa _root; // ignore: unused_field

	// Translations
	@override String get name => 'مسدودسازی تبلیغات';
	@override String get description => '';
}

// Path: pages.settings.routing.predefinedRules.bypassLan
class TranslationsPagesSettingsRoutingPredefinedRulesBypassLanFa extends TranslationsPagesSettingsRoutingPredefinedRulesBypassLanEn {
	TranslationsPagesSettingsRoutingPredefinedRulesBypassLanFa._(TranslationsFa root) : this._root = root, super.internal(root);

	final TranslationsFa _root; // ignore: unused_field

	// Translations
	@override String get name => 'دور زدن LAN';
	@override String get description => '';
}

// Path: pages.settings.chain.levels.app
class TranslationsPagesSettingsChainLevelsAppFa extends TranslationsPagesSettingsChainLevelsAppEn {
	TranslationsPagesSettingsChainLevelsAppFa._(TranslationsFa root) : this._root = root, super.internal(root);

	final TranslationsFa _root; // ignore: unused_field

	// Translations
	@override String get title => 'اپلیکیشن';
	@override String get msg => 'نقطه شروع: ترافیک اپلیکیشن شما از اینجا وارد زنجیره شده و از لایه‌های بعدی عبور می‌کند تا برای میان‌بر نهایی آماده شود';
}

// Path: pages.settings.chain.levels.extraSecurity
class TranslationsPagesSettingsChainLevelsExtraSecurityFa extends TranslationsPagesSettingsChainLevelsExtraSecurityEn {
	TranslationsPagesSettingsChainLevelsExtraSecurityFa._(TranslationsFa root) : this._root = root, super.internal(root);

	final TranslationsFa _root; // ignore: unused_field

	// Translations
	@override String get title => 'امنیت بیشتر';
	@override String get msg => 'یک لایه حفاظتی اضافه برای خصوصی ماندن داده‌های شما، حتی اگر پروفایل اصلی قابل اعتماد نباشد';
}

// Path: pages.settings.chain.levels.mainProfile
class TranslationsPagesSettingsChainLevelsMainProfileFa extends TranslationsPagesSettingsChainLevelsMainProfileEn {
	TranslationsPagesSettingsChainLevelsMainProfileFa._(TranslationsFa root) : this._root = root, super.internal(root);

	final TranslationsFa _root; // ignore: unused_field

	// Translations
	@override String get title => 'پروفایل اصلی';
}

// Path: pages.settings.chain.levels.unblocker
class TranslationsPagesSettingsChainLevelsUnblockerFa extends TranslationsPagesSettingsChainLevelsUnblockerEn {
	TranslationsPagesSettingsChainLevelsUnblockerFa._(TranslationsFa root) : this._root = root, super.internal(root);

	final TranslationsFa _root; // ignore: unused_field

	// Translations
	@override String get title => 'رفع مسدودیت';
	@override String get msg => 'به دور زدن محدودیت‌های شبکه کمک می‌کند. اگر این کمکی متصل شود، پروفایل اصلی شما حتی در صورت مسدود بودن همچنان کار می‌کند';
}

// Path: pages.settings.chain.levels.filtering
class TranslationsPagesSettingsChainLevelsFilteringFa extends TranslationsPagesSettingsChainLevelsFilteringEn {
	TranslationsPagesSettingsChainLevelsFilteringFa._(TranslationsFa root) : this._root = root, super.internal(root);

	final TranslationsFa _root; // ignore: unused_field

	// Translations
	@override String get title => 'فیلترینگ';
	@override String get msg => 'خروجی نهایی: پس از عبور از لایه‌های فعال (امنیت اضافی، پروفایل اصلی یا رفع مسدودیت) و اعمال اثرات آن‌ها، ترافیک شما در نهایت برای عبور از فیلترینگ شبکه محلی مسیریابی می‌شود';
}

// Path: pages.settings.chain.warp.noise
class TranslationsPagesSettingsChainWarpNoiseFa extends TranslationsPagesSettingsChainWarpNoiseEn {
	TranslationsPagesSettingsChainWarpNoiseFa._(TranslationsFa root) : this._root = root, super.internal(root);
...
class TranslationsPagesSettingsChainPsiphonRegionsFa extends TranslationsPagesSettingsChainPsiphonRegionsEn {
	TranslationsPagesSettingsChainPsiphonRegionsFa._(TranslationsFa root) : this._root = root, super.internal(root);

	final TranslationsFa _root; // ignore: unused_field

	// Translations
	@override String get auto => _root.common.auto;
	@override String get at => 'اتریش (at)';
	@override String get au => 'استرالیا (au)';
	@override String get be => 'بلژیک (be)';
	@override String get bg => 'بلغارستان (bg)';
	@override String get ca => 'کانادا (ca)';
	@override String get ch => 'سوئیس (ch)';
	@override String get cz => 'جمهوری چک (cz)';
	@override String get de => 'آلمان (de)';
	@override String get dk => 'دانمارک (dk)';
	@override String get ee => 'استونی (ee)';
	@override String get es => 'اسپانیا (es)';
	@override String get fi => 'فنلاند (fi)';
	@override String get fr => 'فرانسه (fr)';
	@override String get gb => 'بریتانیا (gb)';
	@override String get hr => 'کرواسی (hr)';
	@override String get hu => 'مجارستان (hu)';
	@override String get ie => 'ایرلند (ie)';
	@override String get kIn => 'هند (in)';
	@override String get it => 'ایتالیا (it)';
	@override String get jp => 'ژاپن (jp)';
	@override String get lv => 'لتونی (lv)';
	@override String get nl => 'هلند (nl)';
	@override String get no => 'نروژ (no)';
	@override String get pl => 'لهستان (pl)';
	@override String get pt => 'پرتغال (pt)';
	@override String get ro => 'رومانی (ro)';
	@override String get rs => 'صربستان (rs)';
	@override String get se => 'سوئد (se)';
	@override String get sg => 'سنگاپور (sg)';
	@override String get sk => 'اسلواکی (sk)';
	@override String get us => 'ایالات متحده (us)';
}
...
class TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyOptionsFa extends TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyOptionsEn {
	TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyOptionsFa._(TranslationsFa root) : this._root = root, super.internal(root);

	final TranslationsFa _root; // ignore: unused_field

	// Translations
	@override late final TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyOptionsImportFa import = TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyOptionsImportFa._(_root);
	@override late final TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyOptionsExportFa export = TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyOptionsExportFa._(_root);
...
class TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyModesFa extends TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyModesEn {
	TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyModesFa._(TranslationsFa root) : this._root = root, super.internal(root);
...
class TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyAutoSelectionFa extends TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyAutoSelectionEn {
	TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyAutoSelectionFa._(TranslationsFa root) : this._root = root, super.internal(root);
	...
	@override String get autoUpdateInterval => 'فاصله زمانی به‌روزرسانی خودکار';
	@override late final TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyAutoSelectionToastFa toast = TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyAutoSelectionToastFa._(_root);
	@override late final TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyAutoSelectionDialogFa dialog = TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyAutoSelectionDialogFa._(_root);
}

// Path: pages.settings.routing.generalOptions.perAppProxy.options.import
class TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyOptionsImportFa extends TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyOptionsImportEn {
	TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyOptionsImportFa._(TranslationsFa root) : this._root = root, super.internal(root);
...
class TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyOptionsExportFa extends TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyOptionsExportEn {
	TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyOptionsExportFa._(TranslationsFa root) : this._root = root, super.internal(root);
...
class TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyAutoSelectionToastFa extends TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyAutoSelectionToastEn {
	TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyAutoSelectionToastFa._(TranslationsFa root) : this._root = root, super.internal(root);
...
class TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyAutoSelectionDialogFa extends TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyAutoSelectionDialogEn {
	TranslationsPagesSettingsRoutingGeneralOptionsPerAppProxyAutoSelectionDialogFa._(TranslationsFa root) : this._root = root, super.internal(root);
...
extension on TranslationsFa {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			case 'common.appTitle': return 'هیدیفای';
			...
			case 'common.disable': return 'غیرفعال';
			case 'common.psiphon': return 'سایفون';
			case 'common.profile': return 'پروفایل';
			case 'common.configuration': return 'پیکربندی';
			case 'common.file': return 'فایل';
			...
			case 'common.msg.autoSave.success': return 'تغییرات با موفقیت به‌طور خودکار ذخیره شد';
			...
			case 'pages.home.quickSettings': return 'گزینه‌های تنظیمات سریع';
			...
			case 'pages.proxies.sortOptions.usage': return 'بر اساس استفاده';
			...
			case 'pages.settings.routing.routeRule.empty': return 'هنوز هیچ قانونی اضافه نشده است\n\nبرای ایجاد قانون جدید یا انتخاب از قوانین پیش‌فرض، روی دکمه + ضربه بزنید';
			case 'pages.settings.routing.routeRule.delete': return 'حذف قانون';
			case 'pages.settings.routing.routeRule.create': return 'ایجاد قانون جدید';
			...
			case 'pages.settings.routing.generalOptions.title': return 'تنظیمات عمومی مسیریابی';
			case 'pages.settings.routing.generalOptions.region': return 'منطقه';
			case 'pages.settings.routing.generalOptions.regions.ir': return 'ایران (ir)';
			case 'pages.settings.routing.generalOptions.regions.cn': return 'چین (cn)';
			case 'pages.settings.routing.generalOptions.regions.ru': return 'روسیه (ru)';
			case 'pages.settings.routing.generalOptions.regions.af': return 'افغانستان (af)';
			case 'pages.settings.routing.generalOptions.regions.id': return 'اندونزی (id)';
			case 'pages.settings.routing.generalOptions.regions.tr': return 'ترکیه (tr)';
			case 'pages.settings.routing.generalOptions.regions.br': return 'برزیل (br)';
			case 'pages.settings.routing.generalOptions.regions.other': return 'سایر';
			case 'pages.settings.routing.generalOptions.balancerStrategy.title': return 'استراتژی Balancer';
			...
			case 'pages.settings.routing.generalOptions.resolveDestination': return 'تحلیل آدرس مقصد';
			case 'pages.settings.routing.generalOptions.ipv6Route': return 'مسیریابی IPv6';
			case 'pages.settings.routing.generalOptions.ipv6Modes.disable': return 'غیرفعال';
			case 'pages.settings.routing.generalOptions.ipv6Modes.enable': return 'فعال';
			case 'pages.settings.routing.generalOptions.ipv6Modes.prefer': return 'ترجیحی';
			case 'pages.settings.routing.generalOptions.ipv6Modes.only': return 'انحصاری';
			case 'pages.settings.routing.generalOptions.perAppProxy.title': return 'پروکسی برای هر برنامه';
			case 'pages.settings.routing.generalOptions.perAppProxy.hideSysApps': return 'پنهان کردن برنامه‌های سیستمی';
			case 'pages.settings.routing.generalOptions.perAppProxy.options.import.clipboard': return 'وارد کردن انتخاب‌ها از کلیپ‌بورد';
			case 'pages.settings.routing.generalOptions.perAppProxy.options.import.file': return 'وارد کردن انتخاب‌ها از فایل';
			case 'pages.settings.routing.generalOptions.perAppProxy.options.import.msg': return 'وارد کردن، انتخاب‌های فعلی شما را جایگزین خواهد کرد. آیا مطمئن هستید که می‌خواهید ادامه دهید؟';
			case 'pages.settings.routing.generalOptions.perAppProxy.options.export.clipboard': return 'کپی انتخاب‌ها به کلیپ‌بورد';
			case 'pages.settings.routing.generalOptions.perAppProxy.options.export.file': return 'خروجی انتخاب‌ها به فایل';
			case 'pages.settings.routing.generalOptions.perAppProxy.options.shareToAll': return 'اشتراک‌گذاری با همه';
			case 'pages.settings.routing.generalOptions.perAppProxy.options.clearAllSelections': return 'پاک کردن تمام انتخاب‌ها';
			case 'pages.settings.routing.generalOptions.perAppProxy.modes.all': return 'همه';
			case 'pages.settings.routing.generalOptions.perAppProxy.modes.proxy': return 'پروکسی';
			case 'pages.settings.routing.generalOptions.perAppProxy.modes.bypass': return 'دور زدن';
			case 'pages.settings.routing.generalOptions.perAppProxy.modes.allMsg': return 'پروکسی کردن تمام برنامه‌ها';
			case 'pages.settings.routing.generalOptions.perAppProxy.modes.proxyMsg': return 'فقط برنامه‌های انتخاب‌شده پروکسی شوند';
			case 'pages.settings.routing.generalOptions.perAppProxy.modes.bypassMsg': return 'برنامه‌های انتخاب‌شده پروکسی نشوند';
			case 'pages.settings.routing.generalOptions.perAppProxy.autoSelection.title': return 'انتخاب خودکار';
			case 'pages.settings.routing.generalOptions.perAppProxy.autoSelection.performNow': return 'اکنون انجام بده';
			case 'pages.settings.routing.generalOptions.perAppProxy.autoSelection.resetToDefault': return 'بازنشانی به پیش‌فرض';
			case 'pages.settings.routing.generalOptions.perAppProxy.autoSelection.autoUpdateInterval': return 'فاصله زمانی به‌روزرسانی خودکار';
			case 'pages.settings.routing.generalOptions.perAppProxy.autoSelection.toast.success': return 'انتخاب خودکار برنامه‌ها با موفقیت انجام شد';
			case 'pages.settings.routing.generalOptions.perAppProxy.autoSelection.toast.failure': return 'انتخاب خودکار ناموفق بود';
			case 'pages.settings.routing.generalOptions.perAppProxy.autoSelection.toast.regionNotFound': return ({required Object region}) => 'انتخاب خودکار برای منطقه "${region}" یافت نشد';
			case 'pages.settings.routing.generalOptions.perAppProxy.autoSelection.toast.alreadyInAuto': return 'انتخاب‌های شما از قبل در لیست خودکار موجود است';
			case 'pages.settings.routing.generalOptions.perAppProxy.autoSelection.dialog.title': return 'انتخاب خودکار برنامه‌ها';
			case 'pages.settings.routing.generalOptions.perAppProxy.autoSelection.dialog.msg': return ({required Object region}) => 'قابلیت انتخاب خودکار برای پروکسی هر برنامه به دلیل تغییر منطقه به "${region}" غیرفعال شد';
			case 'pages.settings.routing.predefinedRules.title': return 'قوانین پیش‌فرض';
			case 'pages.settings.routing.predefinedRules.ads.name': return 'مسدودسازی تبلیغات';
			case 'pages.settings.routing.predefinedRules.ads.description': return '';
			case 'pages.settings.routing.predefinedRules.bypassLan.name': return 'دور زدن LAN';
			...
			case 'pages.settings.inbound.lanSharing': return 'اشتراک VPN';
			case 'pages.settings.inbound.lanSharingPasswordNotSet': return 'رمز عبور تنظیم نشده';
			case 'pages.settings.inbound.lanSharingPassword': return 'رمز عبور اشتراک VPN';
			case 'pages.settings.inbound.copyLink': return 'کپی لینک';
			case 'pages.settings.inbound.qrCode': return 'کد QR';
			case 'pages.settings.inbound.lanIPError': return 'خطا در دریافت آدرس IP محلی';
			...
			case 'pages.settings.chain.title': return 'زنجیره';
			case 'pages.settings.chain.subtitle': return 'امنیت بیشتر و رفع مسدودیت';
			case 'pages.settings.chain.finalIp': return 'آی‌پی نهایی';
			case 'pages.settings.chain.levels.app.title': return 'اپلیکیشن';
			case 'pages.settings.chain.levels.app.msg': return 'نقطه شروع: ترافیک اپلیکیشن شما از اینجا وارد زنجیره شده و از لایه‌های بعدی عبور می‌کند تا برای میان‌بر نهایی آماده شود';
			case 'pages.settings.chain.levels.extraSecurity.title': return 'امنیت بیشتر';
			case 'pages.settings.chain.levels.extraSecurity.msg': return 'یک لایه حفاظتی اضافه برای خصوصی ماندن داده‌های شما، حتی اگر پروفایل اصلی قابل اعتماد نباشد';
			case 'pages.settings.chain.levels.mainProfile.title': return 'پروفایل اصلی';
			case 'pages.settings.chain.levels.unblocker.title': return 'رفع مسدودیت';
			case 'pages.settings.chain.levels.unblocker.msg': return 'به دور زدن محدودیت‌های شبکه کمک می‌کند. اگر این کمکی متصل شود، پروفایل اصلی شما حتی در صورت مسدود بودن همچنان کار می‌کند';
			case 'pages.settings.chain.levels.filtering.title': return 'فیلترینگ';
			case 'pages.settings.chain.levels.filtering.msg': return 'خروجی نهایی: پس از عبور از لایه‌های فعال (امنیت اضافی، پروفایل اصلی یا رفع مسدودیت) و اعمال اثرات آن‌ها، ترافیک شما در نهایت برای عبور از فیلترینگ شبکه محلی مسیریابی می‌شود';
			case 'pages.settings.chain.warp.missingConfig': return 'کانفیگ WARP موجود نیست';
			case 'pages.settings.chain.warp.licenseKey': return 'کلید لایسنس';
			case 'pages.settings.chain.warp.cleanIp': return 'آی‌پی تمیز';
			case 'pages.settings.chain.warp.port': return 'پورت';
			case 'pages.settings.chain.warp.noise.count': return 'تعداد نویز';
			case 'pages.settings.chain.warp.noise.mode': return 'حالت نویز';
			case 'pages.settings.chain.warp.noise.size': return 'اندازه نویز';
			case 'pages.settings.chain.warp.noise.delay': return 'تأخیر نویز';
			case 'pages.settings.chain.psiphon.selectServerRegion': return 'انتخاب منطقه سرور';
			case 'pages.settings.chain.psiphon.regions.auto': return _root.common.auto;
			case 'pages.settings.chain.psiphon.regions.at': return 'اتریش (at)';
			case 'pages.settings.chain.psiphon.regions.au': return 'استرالیا (au)';
			case 'pages.settings.chain.psiphon.regions.be': return 'بلژیک (be)';
			case 'pages.settings.chain.psiphon.regions.bg': return 'بلغارستان (bg)';
			case 'pages.settings.chain.psiphon.regions.ca': return 'کانادا (ca)';
			case 'pages.settings.chain.psiphon.regions.ch': return 'سوئیس (ch)';
			case 'pages.settings.chain.psiphon.regions.cz': return 'جمهوری چک (cz)';
			case 'pages.settings.chain.psiphon.regions.de': return 'آلمان (de)';
			case 'pages.settings.chain.psiphon.regions.dk': return 'دانمارک (dk)';
			case 'pages.settings.chain.psiphon.regions.ee': return 'استونی (ee)';
			case 'pages.settings.chain.psiphon.regions.es': return 'اسپانیا (es)';
			case 'pages.settings.chain.psiphon.regions.fi': return 'فنلاند (fi)';
			case 'pages.settings.chain.psiphon.regions.fr': return 'فرانسه (fr)';
			case 'pages.settings.chain.psiphon.regions.gb': return 'بریتانیا (gb)';
			case 'pages.settings.chain.psiphon.regions.hr': return 'کرواسی (hr)';
			case 'pages.settings.chain.psiphon.regions.hu': return 'مجارستان (hu)';
			case 'pages.settings.chain.psiphon.regions.ie': return 'ایرلند (ie)';
			case 'pages.settings.chain.psiphon.regions.kIn': return 'هند (in)';
			case 'pages.settings.chain.psiphon.regions.it': return 'ایتالیا (it)';
			case 'pages.settings.chain.psiphon.regions.jp': return 'ژاپن (jp)';
			case 'pages.settings.chain.psiphon.regions.lv': return 'لتونی (lv)';
			case 'pages.settings.chain.psiphon.regions.nl': return 'هلند (nl)';
			case 'pages.settings.chain.psiphon.regions.no': return 'نروژ (no)';
			case 'pages.settings.chain.psiphon.regions.pl': return 'لهستان (pl)';
			case 'pages.settings.chain.psiphon.regions.pt': return 'پرتغال (pt)';
			case 'pages.settings.chain.psiphon.regions.ro': return 'رومانی (ro)';
			case 'pages.settings.chain.psiphon.regions.rs': return 'صربستان (rs)';
			case 'pages.settings.chain.psiphon.regions.se': return 'سوئد (se)';
			case 'pages.settings.chain.psiphon.regions.sg': return 'سنگاپور (sg)';
			case 'pages.settings.chain.psiphon.regions.sk': return 'اسلواکی (sk)';
			case 'pages.settings.chain.psiphon.regions.us': return 'ایالات متحده (us)';
			case 'pages.settings.chain.profile.selectProfile': return 'انتخاب پروفایل';
			case 'pages.settings.chain.profile.conduitPairingId': return 'شناسه جفت‌سازی Conduit';
			...
			case 'dialogs.psiphonLicense.title': return 'قرارداد لایسنس Psiphon';
			...
			case 'dialogs.confirmation.addProfileByDeepLinkWarning.title': return 'افزودن پروفایل؟';
			case 'dialogs.confirmation.addProfileByDeepLinkWarning.message': return ({required Object host}) => 'یک لینک خارجی از «${host}» درخواست افزودن پروفایل جدید دارد. آیا می‌خواهید آن را وارد کنید؟';
			case 'dialogs.confirmation.importRouteRuleByDeepLinkWarning.title': return 'وارد کردن قانون مسیریابی؟';
			case 'dialogs.confirmation.importRouteRuleByDeepLinkWarning.message': return 'وارد کردن قوانین مسیریابی از منابع غیرقابل اعتماد می‌تواند ریسک امنیتی باشد\nفقط در صورتی که به این لینک اعتماد دارید ادامه دهید';
			...
			case 'dialogs.proxyInfo.download': return 'دانلود:';
			case 'dialogs.proxyInfo.upload': return 'آپلود:';
			...
			case 'errors.warp.missingLicense': return 'لایسنس WARP لازم است';
			...
			case 'errors.psiphon.missingLicense': return 'لایسنس Psiphon لازم است';
			case 'errors.psiphon.missingLicenseMsg': return 'پروفایل انتخاب‌شده از ویژگی Psiphon استفاده می‌کند؛ برای استفاده از این قابلیت، باید با لایسنس Psiphon موافقت شود';
			default: return null;
		}
	}
}
