...
String _$freeProfilesFilteredByRegionHash() =>
    r'4bc934eeed32cef8d2269714e5b21f109277a923';

/// See also [freeProfilesFilteredByRegion].
@ProviderFor(freeProfilesFilteredByRegion)
final freeProfilesFilteredByRegionProvider =
    AutoDisposeFutureProvider<List<FreeProfile>>.internal(
      freeProfilesFilteredByRegion,
      name: r'freeProfilesFilteredByRegionProvider',
      debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
          ? null
          : _$freeProfilesFilteredByRegionHash,
      dependencies: null,
...
typedef FreeProfilesFilteredByRegionRef =
    AutoDisposeFutureProviderRef<List<FreeProfile>>;
String _$addProfileNotifierHash() =>
    r'de358938c625850b9b06d700c998963f02fab4c5';

/// See also [AddProfileNotifier].
@ProviderFor(AddProfileNotifier)
final addProfileNotifierProvider =
    AutoDisposeNotifierProvider<AddProfileNotifier, AsyncValue<Unit?>>.internal(
      AddProfileNotifier.new,
      name: r'addProfileNotifierProvider',
      debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
          ? null
          : _$addProfileNotifierHash,
      dependencies: null,
      allTransitiveDependencies: null,
    );
...
String _$updateProfileNotifierHash() =>
    r'9234265c11779be1becab7e6c9cbf015414b4432';
...
class UpdateProfileNotifierFamily extends Family<AsyncValue<Unit?>> {
  ...
  @override
  UpdateProfileNotifierProvider getProviderOverride(
    covariant UpdateProfileNotifierProvider provider,
  ) {
...
/// See also [UpdateProfileNotifier].
class UpdateProfileNotifierProvider
    extends
  ...
  UpdateProfileNotifierProvider(String id)
    : this._internal(
        ...
        debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
            ? null
            : _$updateProfileNotifierHash,
        dependencies: UpdateProfileNotifierFamily._dependencies,
        allTransitiveDependencies:
            UpdateProfileNotifierFamily._allTransitiveDependencies,
        id: id,
      );
  ...
  @override
  AutoDisposeNotifierProviderElement<UpdateProfileNotifier, AsyncValue<Unit?>>
  createElement() {
...
@Deprecated('Will be removed in 3.0. Use Ref instead')
// ignore: unused_element
mixin UpdateProfileNotifierRef
    on AutoDisposeNotifierProviderRef<AsyncValue<Unit?>> {
...
String _$freeSwitchNotifierHash() =>
    r'95156d72387e7d2728ae6e0b103b0ae69da63db6';

/// See also [FreeSwitchNotifier].
@ProviderFor(FreeSwitchNotifier)
final freeSwitchNotifierProvider =
    AutoDisposeNotifierProvider<FreeSwitchNotifier, bool>.internal(
      FreeSwitchNotifier.new,
      name: r'freeSwitchNotifierProvider',
      debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
          ? null
          : _$freeSwitchNotifierHash,
      dependencies: null,
      allTransitiveDependencies: null,
    );

typedef _$FreeSwitchNotifier = AutoDisposeNotifier<bool>;
String _$addProfilePageNotifierHash() =>
    r'74024165d77a1249e9b831c38fdc68a63fff731f';

/// See also [AddProfilePageNotifier].
@ProviderFor(AddProfilePageNotifier)
final addProfilePageNotifierProvider =
    AutoDisposeNotifierProvider<
      AddProfilePageNotifier,
      AddProfilePages
    >.internal(
      ...
      debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
          ? null
          : _$addProfilePageNotifierHash,
      dependencies: null,
      allTransitiveDependencies: null,
    );

typedef _$AddProfilePageNotifier = AutoDisposeNotifier<AddProfilePages>;
String _$freeProfilesNotifierHash() =>
    r'09ab751c276d632ccd53332e3694e30bc78159ae';

/// See also [FreeProfilesNotifier].
@ProviderFor(FreeProfilesNotifier)
final freeProfilesNotifierProvider =
    AutoDisposeAsyncNotifierProvider<
      FreeProfilesNotifier,
      List<FreeProfile>
    >.internal(
