...
String _$genericListNotifierHash() =>
    r'486436f064c5b8c2507e9c87610aeb715953515e';
...
abstract class _$GenericListNotifier
...
class GenericListNotifierFamily extends Family<List<dynamic>> {
  ...
  @override
  GenericListNotifierProvider getProviderOverride(
    covariant GenericListNotifierProvider provider,
  ) {
...
/// See also [GenericListNotifier].
class GenericListNotifierProvider
    extends
        AutoDisposeNotifierProviderImpl<GenericListNotifier, List<dynamic>> {
  /// See also [GenericListNotifier].
  GenericListNotifierProvider(int? ruleListOrder, RuleEnum ruleEnum)
    : this._internal(
        ...
        debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
            ? null
            : _$genericListNotifierHash,
        dependencies: GenericListNotifierFamily._dependencies,
        allTransitiveDependencies:
            GenericListNotifierFamily._allTransitiveDependencies,
        ruleListOrder: ruleListOrder,
        ruleEnum: ruleEnum,
      );
  ...
  @override
  AutoDisposeNotifierProviderElement<GenericListNotifier, List<dynamic>>
  createElement() {
  ...
  bool operator ==(Object other) {
    return other is GenericListNotifierProvider &&
        other.ruleListOrder == ruleListOrder &&
        other.ruleEnum == ruleEnum;
  }
...
class _GenericListNotifierProviderElement
    extends
        AutoDisposeNotifierProviderElement<GenericListNotifier, List<dynamic>>
  ...
  @override
  int? get ruleListOrder =>
      (origin as GenericListNotifierProvider).ruleListOrder;
  @override
