...
mixin _$PerAppProxyBackup {
  ...
  $PerAppProxyBackupCopyWith<PerAppProxyBackup> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $PerAppProxyBackupCopyWith<$Res> {
  factory $PerAppProxyBackupCopyWith(
    PerAppProxyBackup value,
    $Res Function(PerAppProxyBackup) then,
...
/// @nodoc
abstract class _$$PerAppProxyBackupImplCopyWith<$Res>
    implements $PerAppProxyBackupCopyWith<$Res> {
  factory _$$PerAppProxyBackupImplCopyWith(
    _$PerAppProxyBackupImpl value,
    $Res Function(_$PerAppProxyBackupImpl) then,
...
/// @nodoc
class __$$PerAppProxyBackupImplCopyWithImpl<$Res>
    extends _$PerAppProxyBackupCopyWithImpl<$Res, _$PerAppProxyBackupImpl>
    implements _$$PerAppProxyBackupImplCopyWith<$Res> {
  __$$PerAppProxyBackupImplCopyWithImpl(
    _$PerAppProxyBackupImpl _value,
    $Res Function(_$PerAppProxyBackupImpl) _then,
  ) : super(_value, _then);
...
class _$PerAppProxyBackupImpl implements _PerAppProxyBackup {
  ...
  factory _$PerAppProxyBackupImpl.fromJson(Map<String, dynamic> json) =>
      _$$PerAppProxyBackupImplFromJson(json);
  ...
  _$$PerAppProxyBackupImplCopyWith<_$PerAppProxyBackupImpl> get copyWith =>
      __$$PerAppProxyBackupImplCopyWithImpl<_$PerAppProxyBackupImpl>(
        this,
        _$identity,
      );
...
abstract class _PerAppProxyBackup implements PerAppProxyBackup {
  const factory _PerAppProxyBackup({
    final PerAppProxyBackupMode include,
    final PerAppProxyBackupMode exclude,
  }) = _$PerAppProxyBackupImpl;

  factory _PerAppProxyBackup.fromJson(Map<String, dynamic> json) =
      _$PerAppProxyBackupImpl.fromJson;
...
PerAppProxyBackupMode _$PerAppProxyBackupModeFromJson(
...
mixin _$PerAppProxyBackupMode {
  ...
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $PerAppProxyBackupModeCopyWith<PerAppProxyBackupMode> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $PerAppProxyBackupModeCopyWith<$Res> {
  factory $PerAppProxyBackupModeCopyWith(
    PerAppProxyBackupMode value,
    $Res Function(PerAppProxyBackupMode) then,
...
/// @nodoc
class _$PerAppProxyBackupModeCopyWithImpl<
  $Res,
  $Val extends PerAppProxyBackupMode
>
...
/// @nodoc
abstract class _$$PerAppProxyBackupModeImplCopyWith<$Res>
    implements $PerAppProxyBackupModeCopyWith<$Res> {
...
class __$$PerAppProxyBackupModeImplCopyWithImpl<$Res>
    extends
        _$PerAppProxyBackupModeCopyWithImpl<$Res, _$PerAppProxyBackupModeImpl>
...
class _$PerAppProxyBackupModeImpl implements _PerAppProxyBackupMode {
  const _$PerAppProxyBackupModeImpl({
    final List<String> selected = const [],
    final List<String> deselected = const [],
  }) : _selected = selected,
       _deselected = deselected;

  factory _$PerAppProxyBackupModeImpl.fromJson(Map<String, dynamic> json) =>
      _$$PerAppProxyBackupModeImplFromJson(json);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$PerAppProxyBackupModeImplCopyWith<_$PerAppProxyBackupModeImpl>
  get copyWith =>
      __$$PerAppProxyBackupModeImplCopyWithImpl<_$PerAppProxyBackupModeImpl>(
        this,
        _$identity,
      );
...
abstract class _PerAppProxyBackupMode implements PerAppProxyBackupMode {
  const factory _PerAppProxyBackupMode({
    final List<String> selected,
    final List<String> deselected,
  }) = _$PerAppProxyBackupModeImpl;

  factory _PerAppProxyBackupMode.fromJson(Map<String, dynamic> json) =
      _$PerAppProxyBackupModeImpl.fromJson;
