...
String _$profileDetailsNotifierHash() =>
    r'98fdc3c0d584089be337a0b2f834e39804425856';
...
abstract class _$ProfileDetailsNotifier
  ...
  FutureOr<ProfileDetailsState> build(String id);
}
...
class ProfileDetailsNotifierFamily
  ...
  /// See also [ProfileDetailsNotifier].
  ProfileDetailsNotifierProvider call(String id) {
    return ProfileDetailsNotifierProvider(id);
  }
...
class ProfileDetailsNotifierProvider
    extends
        ...
        > {
  /// See also [ProfileDetailsNotifier].
  ProfileDetailsNotifierProvider(String id)
    : this._internal(
        () => ProfileDetailsNotifier()..id = id,
  ...
  bool operator ==(Object other) {
    return other is ProfileDetailsNotifierProvider && other.id == id;
  }
...
class _ProfileDetailsNotifierProviderElement
    extends
        AutoDisposeAsyncNotifierProviderElement<
          ...
          ProfileDetailsState
        >
    with ProfileDetailsNotifierRef {
