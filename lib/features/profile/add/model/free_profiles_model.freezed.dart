...
mixin _$FreeProfilesModel {
  ...
  $FreeProfilesModelCopyWith<FreeProfilesModel> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $FreeProfilesModelCopyWith<$Res> {
  factory $FreeProfilesModelCopyWith(
    FreeProfilesModel value,
    $Res Function(FreeProfilesModel) then,
...
/// @nodoc
abstract class _$$FreeProfilesModelImplCopyWith<$Res>
    implements $FreeProfilesModelCopyWith<$Res> {
  factory _$$FreeProfilesModelImplCopyWith(
    _$FreeProfilesModelImpl value,
    $Res Function(_$FreeProfilesModelImpl) then,
...
/// @nodoc
class __$$FreeProfilesModelImplCopyWithImpl<$Res>
    extends _$FreeProfilesModelCopyWithImpl<$Res, _$FreeProfilesModelImpl>
    implements _$$FreeProfilesModelImplCopyWith<$Res> {
  __$$FreeProfilesModelImplCopyWithImpl(
    _$FreeProfilesModelImpl _value,
    $Res Function(_$FreeProfilesModelImpl) _then,
  ) : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$FreeProfilesModelImpl
    with DiagnosticableTreeMixin
    implements _FreeProfilesModel {
  const _$FreeProfilesModelImpl({required final List<FreeProfile> profiles})
    : _profiles = profiles;

  factory _$FreeProfilesModelImpl.fromJson(Map<String, dynamic> json) =>
      _$$FreeProfilesModelImplFromJson(json);
  ...
  _$$FreeProfilesModelImplCopyWith<_$FreeProfilesModelImpl> get copyWith =>
      __$$FreeProfilesModelImplCopyWithImpl<_$FreeProfilesModelImpl>(
        this,
        _$identity,
      );
...
abstract class _FreeProfilesModel implements FreeProfilesModel {
  const factory _FreeProfilesModel({
    required final List<FreeProfile> profiles,
  }) = _$FreeProfilesModelImpl;

  factory _FreeProfilesModel.fromJson(Map<String, dynamic> json) =
      _$FreeProfilesModelImpl.fromJson;
...
mixin _$FreeProfile {
  ...
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $FreeProfileCopyWith<FreeProfile> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $FreeProfileCopyWith<$Res> {
  factory $FreeProfileCopyWith(
    FreeProfile value,
    $Res Function(FreeProfile) then,
...
/// @nodoc
class _$FreeProfileCopyWithImpl<$Res, $Val extends FreeProfile>
    implements $FreeProfileCopyWith<$Res> {
...
/// @nodoc
abstract class _$$FreeProfileImplCopyWith<$Res>
    implements $FreeProfileCopyWith<$Res> {
  factory _$$FreeProfileImplCopyWith(
    _$FreeProfileImpl value,
    $Res Function(_$FreeProfileImpl) then,
...
/// @nodoc
class __$$FreeProfileImplCopyWithImpl<$Res>
    extends _$FreeProfileCopyWithImpl<$Res, _$FreeProfileImpl>
    implements _$$FreeProfileImplCopyWith<$Res> {
  __$$FreeProfileImplCopyWithImpl(
    _$FreeProfileImpl _value,
    $Res Function(_$FreeProfileImpl) _then,
  ) : super(_value, _then);
...
class _$FreeProfileImpl with DiagnosticableTreeMixin implements _FreeProfile {
  ...
  factory _$FreeProfileImpl.fromJson(Map<String, dynamic> json) =>
      _$$FreeProfileImplFromJson(json);
...
abstract class _FreeProfile implements FreeProfile {
  ...
  factory _FreeProfile.fromJson(Map<String, dynamic> json) =
      _$FreeProfileImpl.fromJson;
...
mixin _$StringByLocale {
  ...
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $StringByLocaleCopyWith<StringByLocale> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $StringByLocaleCopyWith<$Res> {
  factory $StringByLocaleCopyWith(
    StringByLocale value,
    $Res Function(StringByLocale) then,
...
/// @nodoc
class _$StringByLocaleCopyWithImpl<$Res, $Val extends StringByLocale>
    implements $StringByLocaleCopyWith<$Res> {
...
/// @nodoc
abstract class _$$StringByLocaleImplCopyWith<$Res>
    implements $StringByLocaleCopyWith<$Res> {
  factory _$$StringByLocaleImplCopyWith(
    _$StringByLocaleImpl value,
    $Res Function(_$StringByLocaleImpl) then,
...
/// @nodoc
class __$$StringByLocaleImplCopyWithImpl<$Res>
    extends _$StringByLocaleCopyWithImpl<$Res, _$StringByLocaleImpl>
    implements _$$StringByLocaleImplCopyWith<$Res> {
  __$$StringByLocaleImplCopyWithImpl(
    _$StringByLocaleImpl _value,
    $Res Function(_$StringByLocaleImpl) _then,
  ) : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$StringByLocaleImpl
    with DiagnosticableTreeMixin
    implements _StringByLocale {
  const _$StringByLocaleImpl({required this.en, required this.fa});

  factory _$StringByLocaleImpl.fromJson(Map<String, dynamic> json) =>
      _$$StringByLocaleImplFromJson(json);
  ...
  _$$StringByLocaleImplCopyWith<_$StringByLocaleImpl> get copyWith =>
      __$$StringByLocaleImplCopyWithImpl<_$StringByLocaleImpl>(
        this,
        _$identity,
      );
...
abstract class _StringByLocale implements StringByLocale {
  const factory _StringByLocale({
    required final String en,
    required final String fa,
  }) = _$StringByLocaleImpl;

  factory _StringByLocale.fromJson(Map<String, dynamic> json) =
      _$StringByLocaleImpl.fromJson;
...
mixin _$ListOfStringByLocale {
  ...
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $ListOfStringByLocaleCopyWith<ListOfStringByLocale> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ListOfStringByLocaleCopyWith<$Res> {
  factory $ListOfStringByLocaleCopyWith(
    ListOfStringByLocale value,
    $Res Function(ListOfStringByLocale) then,
...
/// @nodoc
class _$ListOfStringByLocaleCopyWithImpl<
  $Res,
  $Val extends ListOfStringByLocale
>
...
/// @nodoc
abstract class _$$ListOfStringByLocaleImplCopyWith<$Res>
    implements $ListOfStringByLocaleCopyWith<$Res> {
...
/// @nodoc
@JsonSerializable()
class _$ListOfStringByLocaleImpl
    with DiagnosticableTreeMixin
    implements _ListOfStringByLocale {
  const _$ListOfStringByLocaleImpl({
    required final List<String> en,
    required final List<String> fa,
  }) : _en = en,
       _fa = fa;

  factory _$ListOfStringByLocaleImpl.fromJson(Map<String, dynamic> json) =>
      _$$ListOfStringByLocaleImplFromJson(json);
  ...
  int get hashCode => Object.hash(
    ...
    const DeepCollectionEquality().hash(_fa),
  );
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$ListOfStringByLocaleImplCopyWith<_$ListOfStringByLocaleImpl>
  get copyWith =>
      __$$ListOfStringByLocaleImplCopyWithImpl<_$ListOfStringByLocaleImpl>(
        this,
        _$identity,
      );
...
abstract class _ListOfStringByLocale implements ListOfStringByLocale {
  const factory _ListOfStringByLocale({
    required final List<String> en,
    required final List<String> fa,
  }) = _$ListOfStringByLocaleImpl;

  factory _ListOfStringByLocale.fromJson(Map<String, dynamic> json) =
      _$ListOfStringByLocaleImpl.fromJson;
